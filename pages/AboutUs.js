                    ...
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                      <div class="p-6">
                        ...
                        <p class="leading-relaxed mb-3">
                          Growth has been feasible because of our incredible team.They find a need,
                  ...
                  <div class="p-4 md:w-1/3">
                    <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                      <div class="p-6">
                        ...
                        <p class="leading-relaxed mb-3">
                          Different by design, profound impact.These are Tenets we live by.
                          We also Believe in Humor,dedication, fun and innovation.
                        </p>
                        <div class="flex items-center flex-wrap ">
                          <a class="text-blue-500 inline-flex items-center md:mb-2 lg:mb-0">
                            Learn More
